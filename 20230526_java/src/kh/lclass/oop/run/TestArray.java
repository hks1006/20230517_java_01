...
import kh.lclass.oop.sample.Person; //import는 소속이 다를 때 사용
...
//		obj1.
		...
		personArray3[1] = new Person("김개똥", 19, '남',10);
		personArray3[2] = new Person("김말똥", 22, '남',5);
